...
const RUNTIME = { current_month: 0, inteval_id: 0, app_started: false };
var JSONBIRDDATA = `
{
...
function setMigrantBirdsForMonth(monthIndex){
	// first clear last month's departing
	const departed = document.getElementsByClassName("departing");

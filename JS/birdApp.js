...
const RUNTIME = { current_month: 0, inteval_id: 0, app_started: false, audio_playing: false };
var JSONBIRDDATA = `
{
...
function startApp(){
	if (RUNTIME.inteval_id > 0){
		return;
	}
	checkTimeToMoveBirds();
	console.log(RUNTIME.audio_playing);
	if (RUNTIME.audio_playing){
		RUNTIME.inteval_id = setInterval(checkTimeToMoveBirds, 1000);		
	}
	
}
function pauseApp(){
	clearInterval(RUNTIME.inteval_id);
